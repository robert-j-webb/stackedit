...
The fact is, using `eval` instead of writing a calculator class is a much better option for creating software
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTI5NTYwMTYsLTg5OTMxMDQ1MiwtMT
A5ODgzMzIwN119
-->