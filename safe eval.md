...
The fact is, using `eval` instead of writing a lexer/calculator is a much better option for multiple reasons. Implementing a lexer/calculator 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ5ODY1MjMzOSwtODk5MzEwNDUyLC0xMD
k4ODMzMjA3XX0=
-->