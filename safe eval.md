...
Eval is the universally shunned function of the JavaScript standard library. Folk programming tells us that any usage can be refactored away to code that doesn't rely on it, and that it should never be used on a source that you don't trust. Today, I'
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2NDI2MTIwNCwyMTAwMTEzNjg3LDg4MT
I3NTA1OF19
-->