...
This is very quickly becoming a huge pain for me to write. I have to write complicated tests for this. I have to write a compiler, and a lexer. Imagine having to support floats, boo. Just by looking at the value returned from the backend, it’s hard for me to parse what the formula is supposed to be.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzg1MzQzMDY1LDE0NjUxMDQxMTYsMTAyOD
